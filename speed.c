...
int background = 13; 			// TERMINAL BACKGROUND COLOR (1 TO 16 COLORS)

//BIBLIOTECAS
#include "speed_in.h"		//ARQUIVO DE CONFIGURAÇÃO TECLADO
#include "speed_sys.h"		//ARQUIVO DE CONFIGURAÇÃO MODO DO TERMINAL
#include "speed_color.h"	//ARQUIVO DE CONFIGURAÇÃO DE COR
